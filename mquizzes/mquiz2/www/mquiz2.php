...
<div class="container-fluid">
    <div class="row flex-xl-nowrap">
        ...
        <main class="col-12 col-md-10 col-xl-10 py-md-3 pl-md-5 bd-content" role="main">
            ...
            <h3> Mastery Quiz 2  </h3>
            The following material will be on this mastery quiz:
            <ul>
                <li>Zero-sum game definition</li>
                <li>Minimax Tree exploration</li>
                <li>&alpha;/&beta; pruning</li>
                <li>Purpse and general design of evaluation function</li>
                <li>Expectimax </li>
                <li>Probabilities and Expectations</li>
                <li>Maximum Expected Utility (MEU) and Rationality</li>
            </ul>
        </main>
    </div>  <!-- content -->
</div> <!-- wrapper -->
